...
export function NodeInfoPane({ node }: { node: NodeDetails | null }) {
  ...
  return (
    <div className="col-span-3 bg-purple-600 cornerless-b flex flex-col justify-items-end overflow-hidden min-h-40 p-[1px] gap-[1px]">
      <div
      ...
      <div className="text-purple-300 font-light whitespace-pre-wrap text-sm sm:text-base italic p-2 overflow-auto cornerless-b bg-dark-bg ">
        {node.description}
      </div>
    </div>
  );
